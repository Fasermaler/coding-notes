...
class ContainerNode():
    ...
    def get_dotcode(self, selected_paths, closed_paths, depth, max_depth, containers, show_all, label_wrapper, attrs={}):
        ...
        if depth == 0: #grey namespace/server clusters
            attrs['style'] = 'rounded'
            attrs['color'] = '#0000008F'
        ...
        if max_depth == -1 or depth <= max_depth:
            ...
            outcomes_attrs = { #white outline outcome clusters
            ...
            for outcome_label in self._container_outcomes:
                ...
                outcome_attrs = { #Red outcome boxes
                        'shape':'box',
                        'height':'0.3',
            ...
            for (outcome_label,from_label,to_label) in internal_edges:
                ...
                if show_all \
                    ...
                    edge_attrs = {
                            ...
                            'fontsize':'12',
                            'label':'\\n'.join(label_wrapper.wrap(outcome_label))}
                    edge_attrs['style'] = 'setlinewidth(2), filled'
